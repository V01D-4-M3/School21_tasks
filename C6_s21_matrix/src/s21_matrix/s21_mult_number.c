...
static int validate_mult_number_input(const matrix_t *A, const matrix_t *result) {
...
static void multiply_matrix_by_number(const matrix_t *A, double number, matrix_t *result) {
