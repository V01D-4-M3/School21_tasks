...
void S21Matrix::performElementWiseOperation(const S21Matrix &other, ElementWiseOp op) {
    for (int i = 0; i < rows_; ++i) {
        for (int j = 0; j < cols_; ++j) {
...
void S21Matrix::calculateMatrixMultiplication(const S21Matrix &other, S21Matrix &result) const {
    for (int i = 0; i < rows_; i++) {
...
void S21Matrix::fillMinor(int excluded_row, int excluded_col, S21Matrix &minor) const {
    int minor_row = 0;
    for (int i = 0; i < rows_; i++) {
